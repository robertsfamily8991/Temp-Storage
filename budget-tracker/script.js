...
exportContainer.appendChild(backupBtn);

const restoreBtn = document.createElement("button");
restoreBtn.textContent = "Restore JSON";
restoreBtn.className = "btn-secondary";
exportContainer.appendChild(restoreBtn);
...
backupBtn.addEventListener("click", () => {
  ...
  const link = document.createElement("a");
  link.href = URL.createObjectURL(blob);
  link.download = "budget_entries_backup.json";
  link.click();
});
    ...
    reader.onload = (evt) => {
      try {
        ...
        if (Array.isArray(data)) {
          ...
          saveEntries();
          renderCalendar();
          renderLog();const calendar = document.getElementById("calendar");
const monthTitle = document.getElementById("monthTitle");
const prevMonth = document.getElementById("prevMonth");
const nextMonth = document.getElementById("nextMonth");
const openAddEntryBtn = document.getElementById("openAddEntry");
